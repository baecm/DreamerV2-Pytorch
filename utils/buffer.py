...
class TransitionBuffer:
    def __init__(self, capacity, obs_shape, action_size, seq_len, batch_size,
                 obs_type=np.float32, action_type=np.float32):
    ...
    def _retrieve_batch(self, idxs, n, l):
        ...
        return observation.reshape(l, n, *self.obs_shape), \
